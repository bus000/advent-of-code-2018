{- --- Day 9: Marble Mania ---
 ...
 - 21 players; last marble is worth 6111 points: high score is 54718 30 players; last marble is worth 5807 points: high score is 37305
 -
...
runGame conf
    = catMaybes
    . M.evalState (mapM addMarble [1.._marbleCount conf])
    . createGameState
    $ conf
